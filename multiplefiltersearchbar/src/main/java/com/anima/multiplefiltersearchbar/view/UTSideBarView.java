...
import com.anima.multiplefiltersearchbar.util.DrawUtils;

import java.util.Arrays;
import java.util.List;

public class UTSideBarView extends View {
    ...
    public UTSideBarView(Context context) {
        this(context, null);
    }

    public UTSideBarView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UTSideBarView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttribute(AttributeSet attrs, int defStyleAttr) {
        ...
        mStrokeColor = Color.parseColor("#000000");
        mTextColor = Color.parseColor("#969696");
        mTextSize =
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 10,
                        getResources().getDisplayMetrics());
        mSelectTextColor = Color.parseColor("#FF0000");
        mSelectTextSize =
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 10,
                        getResources().getDisplayMetrics());
        mHintTextColor = Color.parseColor("#FFFFFF");
        mHintTextSize =
        ...
        mHintCircleRadius =
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24,
                        getResources().getDisplayMetrics());
        mHintCircleColor = Color.parseColor("#bef9b81b");
        mHintShape = 0;
        mContentPadding =
    ...
    private void drawLetters(Canvas canvas) {
        ...
        for (int index = 0; index < mLetters.size(); index++) {
            float baseLine = DrawUtils.getTextBaseLineByCenter(
    ...
    private void drawHint(Canvas canvas) {
        ...
        if (mSelect != -1) {
            ...
            float textY = DrawUtils.getTextBaseLineByCenter(getMeasuredHeight() / 2.0f, mTextPaint, mHintTextSize);
